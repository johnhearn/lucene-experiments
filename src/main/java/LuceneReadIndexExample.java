...
public class LuceneReadIndexExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Search by location
        TopDocs foundDocs3 = searchByLocation(6.8, 80.0, searcher);
    ...
    private static TopDocs searchByLocation(double latitude, double longitude, IndexSearcher searcher) throws Exception {
        Query locationQuery = LatLonPoint.newDistanceQuery("location", latitude, longitude, 30000);
        TopDocs docs = searcher.search(locationQuery, 10);
        return docs;
    }
